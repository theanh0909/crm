...
<body>
    ...
    <div id="wrap">
        <div id = "mainmenu">
            <ul>
                <li style="float: left !important; margin-top: 10px;"><img src="../template/img/home-go.png" width="20" height="20" style="margin-bottom: -2px;margin-right: 3px"/><a class="active" href="<?php echo SITE_URL ?>/Mod/show.php">Home</a></li>
                ...
                ?>
                <!--<div id= "searchbar">-->
                <li> <form  action = "<?php echo SITE_URL ?>/Mod/search.php"  method = "post">
                        <table align="right" border = "0">
                            <tr>
                                <td> Từ khóa tìm kiếm </td>
                                <td> <input style="height: 25px; border-radius: 5px" name = "txt_last_running_days" type = "text" size = "35" value="<?php if(isset($_POST['txt_last_running_days'])){ echo $_POST['txt_last_running_days'];} ?>"></td>
