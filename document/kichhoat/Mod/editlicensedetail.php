...
$n = isset($_POST['solan']) ? $_POST['solan'] : "";
...
if(isset($_POST['doikey'])){
    $n = $n+1;
   $result = update_registered_info_1($id, $customername, 'EDIT_ID_HARDWARE', $customerphone, $customeremail, $customeraddress, $lastruningdate, $licenseactivationdate, $licenseexpiredate,$n);
    if ($result) {  
		Log_info('2',$_SESSION['username']);
        header('/editlicensedetail.php?id='.$id);
			
    }
}

if ($customername != "") {
    $result = update_registered_info_1($id, $customername, $hardware_id, $customerphone, $customeremail, $customeraddress, $lastruningdate, $licenseactivationdate, $licenseexpiredate,$n);
    if ($result) {
    ...
    <form action = "" method = "post">
        ...
        <table id = "edit" align = "center">
            ...
            <tr>
                ...
                <td><input class = "ipt" name = "hardware_id" size = "25" type = "text"  readonly = "true" value = "<?php echo $text['hardware_id'] ?>"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class = "ipt" size = "30" name = "customername" type = "text" readonly = "true" value = "<?php echo $text['customer_name'] ?>"/></td>
            </tr>
            <tr>
                <td><label>Phone</label></td>
                <td><input class = "ipt" size = "10" name = "customerphone" type = "text" readonly = "true" value = "<?php echo $text['customer_phone'] ?>"/></td>
            </tr>
            <tr>
                <td><label>Địa chỉ</label></td>
                <td><input class = "ipt" size = "60" name = "customeraddress" type = "text"  readonly = "true" value = "<?php echo $text['customer_address'] ?>"/></td>
            </tr>
            <tr>
                <td><label>Email</label></td>
                <td><input class = "ipt" size = "40" name = "customeremail" type = "text" readonly = "true" value = "<?php echo $text['customer_email'] ?>"/></td>
            </tr>
            <tr>
                <td><label>Ngày kích hoạt</label></td>
                <td><input class = "ipt" size = "11" name = "licenseactivationdate" readonly = "true" type = "text"  value = "<?php echo $text['license_activation_date'] ?>"/></td>
            </tr>
            <tr>
                <td><label>Ngày hết hạn</label></td>
                <td><input class = "ipt" size = "11" name = "licenseexpiredate" type = "text" readonly = "true" value = "<?php echo $text['license_expire_date'] ?>"/></td>
            </tr>
			<tr>
                <td><label>Loại key</label></td>
            ...
            <tr>
                ...
                <td><input class = "ipt" size = "11" name = "lastruningdate" type = "text" readonly = "true" value = "<?php echo $text['last_runing_date'] ?>"/></td>
            </tr>
            <tr>
