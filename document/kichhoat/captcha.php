...
$con = open_db();
$sql = "insert into captcha(ip_address, captcha_text) values('$client_ip', '$captcha_text')";
...
if (!$result) {
    ...
    $capt_collect = $row['captcha'];
    $captcha_text = $capt_collect . "," . $captcha_text;
    $sql = "update captcha set captcha_text = '$captcha_text' where ip_address = '$client_ip'";
...
echo        $this->WriteText($text, $fontcfg);
    ...
    protected function WriteText($text, $fontcfg = array()) {
       ...
       //echo  $fontfile = $this->resourcesPath . '/fonts/' . $fontcfg['font'];
		$fontfile = '/tmp/resources/fonts/AntykwaBold.ttf';
