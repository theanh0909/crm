...
<div id = "rightcolumn">
    <form action = "" method = "post" >
        <h3  align='center'>PHẦN MỀM CÒN 2 NGÀY NỮA HẾT HẠN </h3>
        <?php
        ...
        get_expire_date($iduser, $permarr, ($page-1) * $no_record_per_page, $no_record_per_page);
        ...
        ?>
		<!-- <a href="export_excel_1.php?&date=<?php echo $date; ?>" target="_blank"> xuất ra excel  </a>-->
    </form>
    <?php
