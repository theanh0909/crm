...
//echo '<p align="right"><a  href="../extend/out_put_3ex.php"><img src="../template/images/print.jpg" width="20" height="20" /></a></p>';
...
<div id="rightcolumn">
    <form action="" method="">
        <h3  align='center' class ='gxdh2'>PHẦN MỀM CÒN 3 NGÀY NỮA HẾT HẠN </h3>
        <?php
        echo "<p style='margin-left:15px; color:red'><b>Tổng số máy: " . $total_record . " </b><a href='../extend/out_put_3ex.php'><img src='../template/images/print.jpg' width='22' height='22' /></a>
    <b>- Số key dự toán : " . $total_record1 . "  - Số key dự thầu : " . $total_record2 . "</b></p>";
        get_expire_four_date($iduser, $permarr, ($page-1) * $no_record_per_page, $no_record_per_page);
