...
<body>
    ...
    <div id="wrap">
        <div id = "mainmenu">
            <ul>
                <li style="float: left !important; margin-top: 10px;"><img src="../template/img/home-go.png" width="20" height="20" style="margin-bottom: -2px;margin-right: 3px"/><a class="active" href="<?php echo SITE_URL ?>/views/administrator.php">Home</a></li>
                ...
                if (!isset($_SESSION['status']) || $_SESSION['status'] != 'login') {
                    ...
                    echo "<meta http-equiv = \"refresh\" content=\"0;URL=http://giaxaydung.vn/kichhoat/index.php\">";
                    die();
                } else {
                ...
                //$keyword = isset($_POST['email']) ? $_POST['email'] : "";
                ?>
                <!--<div id= "searchbar">-->
                <li> <form  action = "key_no_reg.php" method = "post">
                        <table align="right" border = "0">
                            <tr>
                                <td> Tìm kiếm theo email </td>
                                <td> <input style="height: 25px; border-radius: 5px" name = "email" type = "text" size = "35" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" ></td>
