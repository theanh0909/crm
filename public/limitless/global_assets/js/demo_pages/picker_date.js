...
var DateTimePickers = function() {
    ...
    var _componentDaterange = function() {
        ...
        //             'Tháng cuối của năm': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
        //         },
        //         opens: 'left',
        ...
        //         $('.daterange-predefined-value').val(start.format('YYYY/MM/DD') + '-' + end.format('YYYY/MM/DD'));
