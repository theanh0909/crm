                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2">
                                    <select class="js-example-basic-single form-control" name="product_type">
            ...
            <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        {!! Form::open(['url' => route('admin.customer.exportCertificateCustomer'), 'method' => 'POST', 'target' => '_blank']) !!}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Xuất danh sách hội viên dự thi</h5>
            ...
            <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Nhập danh sách học viên dự thi</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <table class="table">
                ...
                @foreach($customers as $item)
                    <tr>
                        <td>
                            <p>
                                <b class="text-success">Lĩnh vực: </b> {{($item->product) ? $item->product->name : ''}}
                            </p>
                            <!-- <p>
                        ...
                        <td></td>
                        <td>
                            <textarea cols="30" rows="4" class="form-control noteaction" data-id="{{$item->id}}">{{(!empty($item->transaction)) ? $item->transaction->note : ''}}</textarea>
                        </td>
                        <td>
