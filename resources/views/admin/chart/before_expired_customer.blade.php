                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="day">
                                        @foreach($listDay as $k => $day)
                                            <option
                                                    {{(isset($inputs['day']) && $inputs['day'] == $k ) ? 'selected' : ''}}
                                                    value="{{$k}}">{{$day}}</option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        {!! Form::open(['url' => route('admin.customer.export.beforeExpired'), 'method' => 'POST', 'target' => '_blank']) !!}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Export khách hàng sắp hết hạn</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Đến hạn</label>
                                <div class="col-lg-10">
                                    <select class="form-control" name="day">
                                        @foreach($listDay as $day => $name)
                                            <option
                                                    {{(isset($inputs['day']) && $inputs['day'] == $day ) ? 'selected' : ''}}
                                                    value="{{$day}}">{{$name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p style="text-align: center">
                                <button data-toggle="tooltip" data-theme="dark" class="btn-sm btn btn-info" title="Gửi lại mail"
                                    type="button" onclick="submitformx('#resendEmail{{$item->id}}', 'Xác nhận gửi lại Email?')"><i class="fa fa-inbox"></i>
                                </button>

                                <a href="{{route('admin.customer.edit', ['id' => $item->id])}}" class="btn-sm btn btn-warning" data-toggle="tooltip" data-theme="dark" title="Sửa">
                            ...
                            <p style="text-align: center">
                                ...
                                <a href="{{route('admin.customer.getRenewed', ['id' => $item->id])}}" class="btn-sm btn btn-success" data-toggle="tooltip" data-theme="dark" title="Gia hạn Key"><i class="flaticon-calendar-with-a-clock-time-tools"></i></a>
