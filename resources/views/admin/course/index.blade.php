...
@section('content')
@include('admin.layouts.includes.breadcrumb', ['item1' => 'Customer', 'item2' => 'Danh sách học viên'])
<div class="container">
    <div class="card card-custom">
        ...
        <div class="card-header">
            ...
            <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        {!! Form::open(['url' => route('admin.course.exportExcel'), 'method' => 'POST', 'target' => '_blank']) !!}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Export danh sách học viên</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">Nhập từ ngày</label>
                                <div class="col-lg-12">
            ...
            <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        {!! Form::open(['url' => route('admin.course.importExcel'), 'method' => 'POST', 'files' => true]) !!}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Import danh sách học viên</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p>
                                        <a href="/example/khoahoc.xlsx"><u>Download file mẫu</u></a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <table class="table">
                ...
                @foreach($customers as $item)
                    <tr>
                        <td>
                            <p>
                                <b class="text-success">Khóa học: </b> {{($item->product) ? $item->product->name : ''}}
                            </p>
                            ...
                            <p>
                                ...
                                {{\Carbon\Carbon::parse($item->time_approve)->format('d/m/Y')}}
                            </p>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="{{route('admin.course.edit', ['id' => $item->id])}}" class="btn-sm btn btn-warning" data-toggle="tooltip" data-theme="dark" title="Sửa">
