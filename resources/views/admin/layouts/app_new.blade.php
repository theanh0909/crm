...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				...
				<div class="d-flex flex-column">
					<a href="{{route('admin.user.edit-profile')}}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
						{{auth()->user()->fullname}}
					</a>
	...
	<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
		...
		<!--end::Item-->
		<!--begin::Item-->
		<li class="nav-item mb-2" style="margin-top: 20px" data-toggle="tooltip" title="Thêm đơn hàng" data-placement="left">
