...
@section('content')
@include('admin.layouts.includes.breadcrumb', ['item1' => 'Roles', 'item2' => 'Edit'])
<div class="container">
    <div class="card card-custom">
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">
                    Sửa quyền <small>{{$role->display_name}}</small>
                </h3>
            </div>
        </div>
        ...
        <div class="card-header">
            <div class="card card-custom gutter-b" style="width: 100%">
                ...
                <div class="card-body" style="padding: 2rem 0px">
                    {{ Form::open(['url' => route('admin.roles.update', ['roles' => $role->id]), 'method' => 'PUT']) }}
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Tên hiển thị</label>
                                        {{Form::text('display_name', $role->display_name, ['class' => 'form-control', 'placeholder' => 'Tên hiển thị'])}}
                                    ...
                                    <div class="col-lg-6">
                                        <label>Mã code</label>
                                        {{Form::text('name', $role->name, ['class' => 'form-control', 'placeholder' => 'Mã code'])}}
                                        @if($errors->has('name'))
                                            <span class="text-danger">{{$errors->first('display_name')}}</span>
                                        @endif
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <table>
                                                @foreach($group->permissions as $permission)
                                                    <?php
                                                        $checked = (isset($hasPermissions[$permission->id])) ? 'checked' : '';
                                                    ?>
                                                    <tr>
