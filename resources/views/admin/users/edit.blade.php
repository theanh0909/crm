...
@section('content')
@include('admin.layouts.includes.breadcrumb', ['item1' => 'User', 'item2' => 'Edit'])
<div class="container">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="roles[]" multiple="multiple" class="form-control select" data-fouc>
                                            @foreach($roles as $role)
                                                <?php
                                                    $selected = (isset($hasRoles[$role->id])) ? 'selected' : '';
                                                ?>
                                                        ...
                                                        <td style="padding: 8px 0px">
                                                            <div class="checkbox-list">
                                                                <label class="checkbox">
                                                                    <input {{$checked}} type="checkbox" name="permissions[]" value="{{$permission->id}}"/>
                                                                    <span></span>
                                                                </label>
                                                            </div>             
                                                        </td>
