...
Route::group(['prefix' => 'customer', 'as' => 'customer.'], function() {
    Route::get('/list-registered-edit', 'CustomerController@listRegisteredEdit')->name('list-registered-edit')->middleware(['pms:approve-registered']);
    Route::get('/list-registered-edit/approve/{id}', 'CustomerController@approveRegistered')->name('approve-registered')->middleware(['pms:approve-registered']);
    Route::get('/list-registered-edit/delete/{id}', 'CustomerController@deleteRegistered')->name('delete-registered')->middleware(['pms:approve-registered']);
